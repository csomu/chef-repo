...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "csomu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/csomuchef"
  #   chef.validation_client_name = "csomuchef-validator"
  #   chef.validation_key_path = ".chef/csomuchef-validator.pem"
  # end
end
